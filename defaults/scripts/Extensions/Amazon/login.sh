...
python3 "${DECKY_PLUGIN_DIR}/scripts/oauth_helper.py" amazon "${NILE}" &>> "${DECKY_PLUGIN_LOG_DIR}/amazonlogin.log"
"${DECKY_PLUGIN_DIR}/scripts/gamevault.sh" Amazon loginstatus --flush-cache
